...
export default function Contact(props) {
  return (
    <div id='contact' className='p-16 container lg:flex-col justify-between items-center mx-auto px-8 md:px-24 lg:px-24 w-full pb-24'>
      <h2 className='mt-6 text-3xl font-bold md:text-6xl lg:text-5xl text-center mb-12'> Contact Me </h2>
