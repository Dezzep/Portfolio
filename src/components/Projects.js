  ...
  return (
    ...
    <div className='container grid  grid-cols-1 lg:grid-cols-2  mx-auto px-8 md:px-16 lg:px-24 w-full gap-12 items-center py-6'>
      ...
      <Card 
        ...
        preview='https://dezzep.github.io/Admin-Dashboard/'
        tools1={sass}
        tools2={html5}
        >
