...
export default function Card(props) {
  return (
    <div className=" ease-in duration-200 bg-input/[0.3] p-12 hover:bg-selected-text/[0.13] hover:shadow-lg shadow-md shadow-cyan-500/40 hover:shadow-cyan-500/60 rounded-lg">
      <h2 className="text-pop text-2xl text-center mb-6 md:text-3xl font-semibold">
        {props.title}
      </h2>
      ...
      <p className=" text-slate-100 md:h-36 mx-auto md:text-center md:w-72">
        {props.description}
      </p>
      ...
      <div className="flex-col mx-auto">
        ...
        <div className="container flex gap-6 flex-wrap justify-center mt-4 items-center">
