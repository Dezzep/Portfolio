    ...
    <div id='about' className='p-16 container mt-56 lg:flex-col justify-between items-center mx-auto px-8 md:px-24 lg:px-24 w-full bg-black'>
      ...
      <div className='flex card-list'>
        <article className='card'>
          <h3 className='text-pop mb-2 text-center font-semibold'>Reading</h3>
          ...
          <div className='lg:p-2'>
            ...
            <p className='mt-2'><a className='text-selected-text hover:text-selected-text/[0.7]' href="https://www.calnewport.com/books/deep-work/" rel='noreferrer' target={'blank'}>Deep Work<span className='text-sm'> by Cal Newport</span></a>
         ...
         <article className='card'>
          <h3 className='text-pop mb-2 text-center font-semibold'>Snowboarding</h3>
          ...
          <article className='card'>
          <h3 className='text-pop mb-2 text-center font-semibold'>Gaming</h3>
          ...
          <article className='card'>
          <h3 className='text-pop mb-2 text-center font-semibold'>Camping</h3>
          <p className='ml-2'>Sometimes I bike to my destination, carrying my tent and equipment in saddlebags. Sometimes I canoe, carrying my gear in drybags. Usually I drive. <br/><br/><span className='bg-pop px-1'>Fun fact</span> <br/><span>My longest camping trip was a 12 day canoe trip!</span></p>
          </article>
    </div>
    </div>
  )
